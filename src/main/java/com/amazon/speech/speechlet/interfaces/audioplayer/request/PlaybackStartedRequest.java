...
/**
 * The request object indicating the audio player stream has started playing. Used for
...
public class PlaybackStartedRequest extends AudioPlayerRequest {
    private final long offsetInMilliseconds;
    private final String token;

    /**
     * Returns a new builder instance used to construct a new {@code PlaybackStartedRequest}.
     *
     * @return the builder
     */
    ...
    /**
     * Private constructor to return a new {@code PlaybackStartedRequest} from a {@code Builder}.
     *
     * @param builder
     *            the builder used to construct the {@code PlaybackStartedRequest}
     */
     ...
     */
    private PlaybackStartedRequest(@JsonProperty("requestId") final String requestId,
    ...
    /**
     * Builder used to construct a new {@code PlaybackStartedRequest}.
     */
    public static final class Builder extends
            SpeechletRequest.SpeechletRequestBuilder<Builder, PlaybackStartedRequest> {
