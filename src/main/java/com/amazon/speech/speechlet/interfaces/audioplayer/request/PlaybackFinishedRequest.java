...
public class PlaybackFinishedRequest extends AudioPlayerRequest {
    ...
    /**
     * Returns a new builder instance used to construct a new {@code PlaybackFinishedRequest}.
     *
     * @return the builder
     */
    ...
    /**
     * Private constructor to return a new {@code PlaybackFinishedRequest} from a {@code Builder}.
     *
     * @param builder
     *            the builder used to construct the {@code PlaybackFinishedRequest}
     */
    private PlaybackFinishedRequest(final Builder builder) {
        super(builder);
     ...
     */
    private PlaybackFinishedRequest(@JsonProperty("requestId") final String requestId,
    ...
    /**
     * Builder used to construct a new {@code PlaybackFinishedRequest}.
     */
    public static final class Builder extends
            SpeechletRequest.SpeechletRequestBuilder<Builder, PlaybackFinishedRequest> {
